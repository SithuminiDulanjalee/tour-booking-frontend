      ...
      <div className="mx-auto max-w-5xl px-6 py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="rounded-2xl border border-emerald-400/20 bg-slate-900 p-5">
            ...
            <p className="mt-3 text-xl font-bold text-emerald-400">{lkr(totalPaid)}</p>
            <p className="text-slate-400 text-xs mt-1">Total Paid</p>
          </div>
          <div className="rounded-2xl border border-cyan-400/20 bg-slate-900 p-5">
            <span className="text-2xl">📥</span>
            <p className="mt-3 text-xl font-bold text-cyan-400">{lkr(advancePaid)}</p>
            <p className="text-slate-400 text-xs mt-1">Advances Paid</p>
          </div>
          <div className="rounded-2xl border border-emerald-400/20 bg-slate-900 p-5">
            <span className="text-2xl">✅</span>
            <p className="mt-3 text-xl font-bold text-emerald-400">{lkr(balancePaid)}</p>
            <p className="text-slate-400 text-xs mt-1">Balances Paid</p>
          </div>
          <div className="rounded-2xl border border-purple-400/20 bg-slate-900 p-5">
            <span className="text-2xl">🔄</span>
            <p className="mt-3 text-xl font-bold text-purple-400">{payments.length}</p>
